...
| INTENT-004 | 2026-06-19 | external_review_gate | 合并 PR 队列 `#28 → #29 → #31` | open | `#28`、`#29` 已合并；`#31` 已切到 `main` 且 checks 通过，当前需要非 PR 作者 / 外部 reviewer 对 `#31` approving review 后完成队列 |
